...
_WIREN_TO_HASS_MAPPER: dict[WirenControlType, str] = {
...
_WIREN_TO_HASS_MAPPER1: dict[WirenControlType, HassControlType] = {
    WirenControlType.switch: None,  # see wirenboard_to_hass_type()
...
def wiren_to_hass_type1(control) -> HassControlType:
    ...
    elif control.type in _WIREN_TO_HASS_MAPPER1:
        return _WIREN_TO_HASS_MAPPER1[control.type]
    return None
